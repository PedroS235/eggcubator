...
class MotorController {
   ...
   public:
     ...
     *
     * @param interval is the time interval where the motor will rotate (in hours)
     * @param duration is the amount of time the motor rotates (in seconds)
     */
    MotorController(unsigned long interval, unsigned long duration);
     ...
     */
    void change_rotation_interval_seconds(unsigned long interval);
     ...
     */
    void change_rotation_interval_hours(unsigned long interval);
