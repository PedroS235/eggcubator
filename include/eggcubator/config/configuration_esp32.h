...
#ifndef CONFIGURATION_ESP32_H
#define CONFIGURATION_ESP32_H
...
#define HUMIDIFIER_SENSOR_TYPE DHT22
...
#define UI_I2C_SCK_PIN 22               // 22 for esp32 dev
#define UI_I2C_SDA_PIN 21               // 21 for esp32 dev
