...
class RotaryEncoder {
   public:
    ...
    // simple retrieve of the direction the knob was rotated last time. 0 = No rotation,
    ...
    // call this function every some milliseconds or by using an interrupt for handling
    // state changes of the rotary encoder.
    void tick(void);
   ...
   private:
    ...
    unsigned long
        _positionExtTimePrev;  // The time the previous position change was detected.
