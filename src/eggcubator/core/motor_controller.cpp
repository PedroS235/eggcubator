...
void MotorController::_rotating_state() {
    unsigned long now = millis();
...
unsigned long MotorController::get_rotation_duration() {
    return millis_to_seconds(_rotation_duration);
}
