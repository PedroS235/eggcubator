...
float Thermostat::get_temp() { return temp; }
...
void Thermostat::update_pid_i_term(float new_i) { pid->update_i_term(new_i); }

void Thermostat::update_pid_d_term(float new_d) { pid->update_d_term(new_d); }
