...
MotorController::MotorController(unsigned long interval, unsigned long duration) {
    rotation_duration = sec_to_millis(duration);
...
void MotorController::change_rotation_interval_hours(unsigned long interval) {
    rotation_interval = hour_to_millis(interval);
}

void MotorController::change_rotation_interval_seconds(unsigned long interval) {
